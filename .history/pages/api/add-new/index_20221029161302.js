...
async function handler(req, res) {
  const client = await MongoClient.connect("mongodb+srv://kushagrasaxena061:3TJAslkfXbPdpG2E@cluster0.5qdotzk.mongodb.net/invoices2?retryWrites=true&w=majority" ,
